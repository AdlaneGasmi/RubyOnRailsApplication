...
class PersonnagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personnage" do
    assert_difference('Personnage.count') do
      post personnages_url, params: { personnage: { Nom: @personnage.Nom, Points_attaque: @personnage.Points_attaque, Points_de_vie: @personnage.Points_de_vie } }
    end
  ...
  test "should update personnage" do
    patch personnage_url(@personnage), params: { personnage: { Nom: @personnage.Nom, Points_attaque: @personnage.Points_attaque, Points_de_vie: @personnage.Points_de_vie } }
